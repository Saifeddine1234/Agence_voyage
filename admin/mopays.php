...
<body>
<form name="formee" Method="POST" action="traitementmodifpays.php">

<?php
include_once("connexion.inc.php");
$req="select nomp,urlp FROM 
pays WHERE idp='".$_GET['id']."'";
...
<h5>Nom pays </h5><input class="form-control"  type="text" name="name" value="<?php echo $name ;?>">
